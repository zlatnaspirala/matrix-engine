  ...
  for (var f = 0; f < object.geometry.indices.length; f = f + 3) {
    ...
    if (object.rotation.ry != 0) {
      if (object.rotation.rx != 0) {
        ...
        // ????
        triangle = [
          [rez0[0] + object.position.worldLocation[0], detY0 + object.position.worldLocation[1], rez0[1] ],
          [rez1[0] + object.position.worldLocation[0], detY1 + object.position.worldLocation[1], rez1[1] ],
          [rez2[0] + object.position.worldLocation[0], detY2 + object.position.worldLocation[1], rez2[1] ]
        ];
