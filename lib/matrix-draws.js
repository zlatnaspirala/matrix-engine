...
import {depthTextures} from './matrix-textures';
...
App.operation.draws.drawSquareTex = function(object) {
  ...
  if(object.shadows && object.shadows.type == 'spot' ||
    ...
    if(!object.shadows.depthFramebuffer) {
      ...
      // world.GL.gl.uniform(object.shaderProgram.u_projectedTexture, object.shadows.depthTexture );
    ...
    // world.GL.gl.activeTexture(world.GL.gl['TEXTURE0' + 1]);
