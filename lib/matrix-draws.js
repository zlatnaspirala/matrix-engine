...
App.operation.draws.cube = function(object) {
  ...
  // simple dir for vertex colored 
  if (object.useDirectionLight == true) {
     // Set the color to use
     world.GL.gl.uniform4fv(object.shaderProgram.colorLocation, [0.5, 0.5, 0.5, 0]);
     // set the light direction.
    world.GL.gl.uniform3fv(object.shaderProgram.reverseLightDirectionLocation, m4.normalize(
      [1,0,1]
      ));
  }
