...
App.operation.draws.cube = function (object) {
  ...
  if (lighting && object.shaderProgram.useLightingUniform) {
    ...
    if (object.shaderProgram.ambientColorUniform) {
      if (document.getElementById('ambLightR')) {
        world.GL.gl.uniform3f(
          ...
          parseFloat(document.getElementById('ambLightR').getAttribute('value')),
          parseFloat(document.getElementById('ambLightG').getAttribute('value')),
          parseFloat(document.getElementById('ambLightB').getAttribute('value'))
        );
        // console.log("LIGHTS UNIFORM AMB  B = ", parseFloat(document.getElementById('ambLightB').value) )
      } else {
    ...
    if (object.shaderProgram.directionalColorUniform) {
      if (document.getElementById('dirLightR')) {
        world.GL.gl.uniform3f(
          ...
          parseFloat(document.getElementById('dirLightR').getAttribute('value')),
          parseFloat(document.getElementById('dirLightG').getAttribute('value')),
          parseFloat(document.getElementById('dirLightB').getAttribute('value'))
        );
      } else {
    ...
    if (object.shaderProgram.lightingDirectionUniform) {
      if (document.getElementById('dirX') && document.getElementById('dirY') && document.getElementById('dirZ')) {
        ...
        lightingDirection = [parseFloat(document.getElementById('dirX').getAttribute('value')),
          parseFloat(document.getElementById('dirY').getAttribute('value')),
          parseFloat(document.getElementById('dirZ').getAttribute('value'))];
      } else {
  ...
  if (object.glBlend.blendEnabled == true) {
    ...
    if (object.shadows) {
     ...
     world.GL.gl.uniform3fv(object.shaderProgram.lightWorldPositionLocation, lightPosition);
