...
App.operation.draws.cube = function(object) {
  ...
  if(object.shadows && object.shadows.type == 'spot') {
    ...
    // world.GL.gl.uniform3fv(object.shaderProgram.uLightPosition, [matrixEngine.Events.camera.xPos, matrixEngine.Events.camera.yPos, matrixEngine.Events.camera.zPos]);
