    ...
    if(object.streamTextures != null) {
      ...
      for(var t = 0;t < object.textures.length;t++) {
        if(object.custom.gl_texture == null) {
          ...
          world.GL.gl.texParameteri(world.GL.gl.TEXTURE_2D, world.GL.gl.TEXTURE_WRAP_S, object.texParams.TEXTURE_WRAP_S);
          world.GL.gl.texParameteri(world.GL.gl.TEXTURE_2D, world.GL.gl.TEXTURE_WRAP_T, object.texParams.TEXTURE_WRAP_T);
