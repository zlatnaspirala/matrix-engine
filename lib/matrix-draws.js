...
import {E, gen2DTextFace, radToDeg} from './utility';
	...
	if(object.shadows && object.shadows.type == 'spot' ||
		...
		textureMatrix = m4.multiply(
			...
			const mat = m4.multiply(
				lightWorldMatrix, m4.inverse(object.shadows.lightProjectionMatrix));
		...
		world.GL.gl.uniform3fv(object.shaderProgram.lightWorldPositionLocation, object.position.worldLocation);
		world.GL.gl.uniform3fv(object.shaderProgram.u_world, mat);
		world.GL.gl.uniform3fv(object.shaderProgram.u_reverseLightDirection,  lightWorldMatrix.slice(8,11));
		world.GL.gl.uniform1f(object.shaderProgram.u_bias, -0.01);
...
App.operation.draws.drawObj = function(object, ray) {
	...
	if(object.shadows && object.shadows.type == 'spot' ||
		...
		// set the light position
		world.GL.gl.uniform3fv(object.shaderProgram.lightWorldPositionLocation, object.shadows.lightPosition);
		world.GL.gl.uniform3fv(object.shaderProgram.u_world, object.shadows.lightPosition);
		world.GL.gl.uniform1f(object.shaderProgram.shininessLocation, object.shadows.shininess);
		// Set the spotlight uniforms
		{
