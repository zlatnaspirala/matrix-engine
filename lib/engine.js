...
import {generateCubeMapShaderSrc, generateCustomShaderSrc, generateShaderSimpleDirection, generateShaderSrc, generateVShaderSimpleDirectionLight} from './matrix-shaders';
...
// REGENERATORs SHADER
export var RegenerateCubeMapShader = function (id_elem, numOfSamplerInUse, mixOperand, spotLight) {
  var e = document.getElementById(id_elem);
  ...
  if (typeof spotLight !== 'undefined') {
    e.innerHTML = generateCubeMapShaderSrc(numOfSamplerInUse, mixOperand, spotLight);
  } else {
