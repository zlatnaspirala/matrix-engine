...
import {defineWebGLWorld, initiateFPS, loadShaders, initShaders, RegenerateShader} from './engine';
import {animate, callReDraw_} from './matrix-render';
import drawsOperation from './matrix-draws';
import { MatrixLightComponent, MatrixLightDirection, MatrixButton } from './matrix-tags';
 ...
 */
window.customElements.define('matrix-dir-light', MatrixLightDirection); 
  ...
  world.Add = function (filler, size, nameUniq, texturesPaths, mesh_, animationConstruct_) {
    ...
    */
    ...
    if ('cube' == filler) {
      ...
      // cubeObject.color = new GeoOfColor("square");
