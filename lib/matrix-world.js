...
import {loadShaders2} from './matrix-init-shaders';
...
export var CS1 = "font-family: stormfaze;color: #152211; font-size:58px;text-shadow: 2px 2px 4px #f3fff4, 4px 4px 4px gray, 2px 2px 4px lime, 6px 2px 0px lime;background: black;";
export var CS2 = "font-family: stormfaze;color: #fd1233; font-size:20px;text-shadow: 2px 2px 2px #5321f5, 4px 4px 4px #d6fa16, 3px 0px 3px #c16fa6, 6px 6px 4px #9a0de3;background: black;";
export var CS3 = "font-family: stormfaze;color: #f1f133; font-size:18px;text-shadow: 2px 2px 4px #f335f4, 4px 4px 4px #d64444, 2px 2px 4px #c16fa6, 6px 2px 0px #123de3;background: black;";
export var CS4 = "font-family: wargames;color: #lime; font-size:16px;text-shadow: 2px 2px 4px white, 4px 4px 4px green, 2px 2px 4px #c16fa6, 6px 2px 0px #123de3;background: black;";
...
console.info(`%c You can downgrade to webgl1 with ?GLSL=1.1 - EXPERIMENTAL DEV - WIP`, CS3);
...
if(QueryString.GLSL && QueryString.GLSL == 1.3) {
  // GLSL 1.30 -> opengles3
  console.info(`%cActive cook ⚗️: GLSL 1.3. for OPENGLES30 %c webGL2`, CS2, CS2);
  ...
  // GLSL 1.30 -> opengles3
  App.openglesShaderVersion = 1.3;
  console.info(`%cActive: GLSL 1.3. for OPENGLES30 %c webGL2`, CS2, CS2);
  loadShaders2();
}
    ...
    */
    ...
    if('squareTex' == filler) {
      ...
      if(typeof texturesPaths !== 'undefined') {
        if(typeof texturesPaths == 'string') {
          ...
          RegenerateShader('' + filler + '-shader-fs', texturesPaths.source.length, texturesPaths.mix_operation, 'opengles30');
    ...
    if('sphereTex' == filler || 'sphereLightTex' == filler) {
      ...
      sphereObject.changeMaterial = function(texturesPaths) {
        RegenerateShader(this.type + '-shader-fs', texturesPaths.source.length, texturesPaths.mix_operation, 'opengles30');
    ...
    if('cubeMap' == filler || 'cubeMapTex' == filler) {
      ...
      cubeObject.activateShadows = (t) => {
        ...
        RegenerateShader(filler + '-shader-fs', texturesPaths.source.length, texturesPaths.mix_operation, type);
        cubeObject.shaderProgram = this.initShaders(this.GL.gl, filler + '-shader-fs', filler + '-shader-vs');
      };
      ...
      if(typeof texturesPaths !== 'undefined') {
        if(typeof texturesPaths == 'string') {
          ...
          if (App.openglesShaderVersion == 1.3) {
            RegenerateCubeMapShader(filler + '-shader-fs', texturesPaths.source.length, texturesPaths.mix_operation, 'opengles30');
          } else {
    ...
    if('generatorTex' == filler || 'generatorLightTex' == filler) {
      ...
      if(typeof texturesPaths !== 'undefined') {
        if(typeof texturesPaths == 'string') {
          ...
          // cubeObject.shaderProgram = this.initShaders(this.GL.gl, filler+"-shader-fs", filler+"-shader-vs");
          RegenerateShader('sphereLightTex' + '-shader-fs', texturesPaths.source.length, texturesPaths.mix_operation, 'opengles30');
