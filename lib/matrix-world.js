...
import {defineWebGLWorld,
        initiateFPS,
        RegenerateShaderSimpleDirectionLight,
        RegenerateVShaderSimpleDirectionLight,
        loadShaders, initShaders, RegenerateShader} from './engine';
...
import {_glBlend, _DrawElements, _glTexParameteri} from './utility';
...
import { MatrixShadowSpot } from './matrix-shadows';
    ...
    */
    ...
    if('cubeTex' == filler || 'cubeLightTex' == filler) {
      ...
      cubeObject.activateShadows =  () => {
        ...
        RegenerateShader(
          filler + '-shader-fs',
          texturesPaths.source.length,
          texturesPaths.mix_operation,
          true
        );
      ...
      cubeObject.activatePixelsTex = () => {
        ...
        world.GL.gl.texImage2D(world.GL.gl.TEXTURE_2D, 0, world.GL.gl.RGBA, 2, 2, 0, world.GL.gl.RGBA, world.GL.gl.UNSIGNED_BYTE, pixels);
        return texture;
