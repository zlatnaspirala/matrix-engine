...
export function generateShaderSrc(numTextures, mixOperand, spotLight) {
  return `
    ...
    ` +
     (typeof spotLight !== 'undefined' ? generateSpotLight1() : ``)
      + `
    void main(void) {
        ...
        ` +
        (typeof spotLight !== 'undefined' ? generateSpotLight2() : ``)
         + `
    }
...
function generateEColor() {

}

function generateSpotLight1() {
