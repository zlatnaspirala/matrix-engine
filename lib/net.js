    ...
    this.multiPlayerRef = {
      ...
      update(multiplayer) {
        if(multiplayer.data.netPos) {
          ...
          if (multiplayer.data.netPos.x) App.scene[multiplayer.data.netObjId].position.SetX(multiplayer.data.netPos.x, 'noemit');
          if (multiplayer.data.netPos.y) App.scene[multiplayer.data.netObjId].position.SetY(multiplayer.data.netPos.y, 'noemit');
          if (multiplayer.data.netPos.z) App.scene[multiplayer.data.netObjId].position.SetZ(multiplayer.data.netPos.z, 'noemit');
        } else if (multiplayer.data.netRot) {
          // console.log('ROT INFO ZA UPDATE', multiplayer);
          if (multiplayer.data.netRot.x) App.scene[multiplayer.data.netObjId].rotation.rotx = multiplayer.data.netRot.x; // , 'noemit');
          if (multiplayer.data.netRot.y) App.scene[multiplayer.data.netObjId].rotation.roty = multiplayer.data.netRot.y;
          if (multiplayer.data.netRot.z) App.scene[multiplayer.data.netObjId].rotation.rotz = multiplayer.data.netRot.z;
        } else if (multiplayer.data.netScale) {
           console.log('netScale INFO ZA UPDATE', multiplayer);
          if (multiplayer.data.netScale.x) App.scene[multiplayer.data.netObjId].geometry.setScaleByX(multiplayer.data.netScale.x, 'noemit');
          if (multiplayer.data.netScale.y) App.scene[multiplayer.data.netObjId].geometry.setScaleByY(multiplayer.data.netScale.y, 'noemit');
          if (multiplayer.data.netScale.z) App.scene[multiplayer.data.netObjId].geometry.setScaleByZ(multiplayer.data.netScale.z, 'noemit');
        }
      },
