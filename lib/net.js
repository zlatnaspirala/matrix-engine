    ...
    this.multiPlayerRef = {
      ...
      update(multiplayer) {
        if(multiplayer.data.netPos) {
          ...
          if (multiplayer.data.netRot.x) App.scene[multiplayer.data.netObjId].rotation.rotateX(multiplayer.data.netRot.x, 'noemit');
          if (multiplayer.data.netRot.y) App.scene[multiplayer.data.netObjId].rotation.rotateY(multiplayer.data.netRot.y, 'noemit');
          if (multiplayer.data.netRot.z) App.scene[multiplayer.data.netObjId].rotation.rotateZ(multiplayer.data.netRot.z, 'noemit');
        }
