    ...
    if (App.camera.SceneController === true && SYS.MOUSE.BUTTON_PRESSED == 'MID') {
      ...
      // camera.yPos = SYS.MOUSE.y / 100;
            ...
            if (Math.abs(deltaX) > Math.abs(deltaY) && deltaX > 0) {
              ...
              //up
              if (this.virtualUpDownScene == 0) {
                this.virtualUpDownScene = 0.01 // SYS.MOUSE.y;
              } else {
                this.virtualUpDownScene += 0.01 // (deltaY / 100);
              }
            ...
            console.log(' test down ', this.virtualUpDownScene);
...
let handlerWheelTimeout = 20, wheelBLock = false;
...
camera.setSceneCamera = function (object) {
  ...
  // mat4.rotate(object.mvMatrix, object.mvMatrix, degToRad(-camera.roll), [0, 0, 1]);
