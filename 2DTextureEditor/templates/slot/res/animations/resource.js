...
'HUD/hudX.png' , 
  ...
  RESOURCE.imagesFont1={"source":['imagesFont1/0.png' , 
'imagesFont1/1.png' , 
'imagesFont1/2.png' , 
'imagesFont1/3.png' , 
'imagesFont1/4.png' , 
...
'Sand/sandRight.png' , 
  ...
  RESOURCE.slotBalance={"source":['slotBalance/balancetable.png' , 
 ] }; 
  RESOURCE.slotBG={"source":['slotBG/castle_grey.png' , 
'slotBG/z.png' , 
 ] }; 
  RESOURCE.slotFox={"source":['slotFox/0.png' , 
'slotFox/1.png' , 
'slotFox/2.png' , 
'slotFox/3.png' , 
'slotFox/4.png' , 
...
'slotFox/7.png' , 
  ...
  RESOURCE.SlotHand={"source":['SlotHand/punchHighDisabled.png' , 
'SlotHand/punchLow.png' , 
 ] }; 
  RESOURCE.SlotRabit={"source":['SlotRabit/rabbit.png' , 
 ] }; 
  RESOURCE.SlotSun={"source":['SlotSun/sun1.png' , 
 ] }; 
...
'wbutton/signRight.png' , 
  ...
  RESOURCE.winNLO={"source":['winNLO/0.png' , 
'winNLO/1.png' , 
'winNLO/10.png' , 
'winNLO/11.png' , 
'winNLO/12.png' , 
...
'winNLO/8.png' , 
'winNLO/9.png' , 
 ] }; window.RESOURCE = RESOURCE;  /**SYS.DEBUG.LOG('Resources loaded. ' + 36);*/ 
  RESOURCE.SUM = 36; 